...
function Header({ onAdd, jobCount, searchText, searchField, setSearchText, setSearchField }){
    return (
        <div className="flex mb-6">
            ...
            <SearchBar searchText={searchText} searchField={searchField} setSearchText={setSearchText} setSearchField={setSearchField} />
        </div>
    );
}
